...
$(document).ready(function () {
    ...
    $('#hero-wrapper').slick({
        ...
        arrows: true,
        dots: true,
        prevArrow: '<button type="button" id="hero-prev"><i class="fa fa-angle-left"></i></button>',
        nextArrow: '<button type="button" id="hero-next"><i class="fa fa-angle-right"></i></button>'
    });
